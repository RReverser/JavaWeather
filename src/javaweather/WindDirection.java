...
public enum WindDirection {
    ...
    private static final HashMap<String, WindDirection> directions = new HashMap<String, WindDirection>();
    ...
    private static void initDirections() {
        ...
        directions.put("пн.", NORTH);
        directions.put("пн.-сх.", NORTHEAST);
        directions.put("сх.", EAST);
        directions.put("пд.-сх.", SOUTHEAST);
        directions.put("пд.", SOUTH);
        directions.put("пд.-зх.", SOUTHWEST);
        directions.put("зх", WEST);
        directions.put("пн.-зх.", NORTHWEST);
    }
}
